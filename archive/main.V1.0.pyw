...
config_mgr.log(
    f"=== Mouse4 V1.0 (测试版) Started role={_startup_role} "
...
APPLE_THEME = {
    ...
    'palette': ['#FF3B30', '#FFCC00', '#34C759', '#2997FF', '#00FFFF', '#FF2D95', '#FFFFFF', '#000000'],
    ...
    'toolbar_css': "QWidget { background-color: rgba(24,24,27,0.96); border-radius: 14px; "
                   ...
                   "QPushButton:checked { background: rgba(41,151,255,0.30); color: #2997FF; }",
    'panel_css': "background-color: rgba(24,24,27,0.96); border-radius: 14px; "
                 "border: 1px solid rgba(255,255,255,0.12);",
    ...
    'btn_ok_css': "color: #2997FF; font-weight: bold; font-size: 22px;",
    ...
    'tray_menu_css': (
        "QMenu { background-color: rgba(24,24,27,0.98); border: 1px solid rgba(255,255,255,0.12); "
        "border-radius: 12px; padding: 6px; font-family: 'Microsoft YaHei'; }"
        "QMenu::item { color: #E5E5EA; padding: 8px 24px 8px 12px; border-radius: 8px; background: transparent; }"
        "QMenu::item:selected { background-color: rgba(41,151,255,0.30); color: #2997FF; }"
        "QMenu::separator { height: 1px; background-color: rgba(255,255,255,0.12); margin: 5px 8px; }"
    ),
}
...
APPLE_SVGS = {
    ...
    'pen': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 15 C7 7, 9.5 19, 12.5 11.5 S17.5 6, 20 13.5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>',
    'text': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 6 H20 V9.5 H14 V18 H10 V9.5 H4 Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg>',
    'undo': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7 6 A8 8 0 1 1 7 18 M7 6 L4 3 M7 6 L10 3" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    'cancel': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7.5 7.5 L16.5 16.5 M16.5 7.5 L7.5 16.5" fill="none" stroke="#FF453A" stroke-width="2.4" stroke-linecap="round"/></svg>',
    'ok': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 13 L10 18 L19 7" fill="none" stroke="#2997FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
}
...
class AppleIconButton(QPushButton):
    def __init__(self, svg, parent=None):
        ...
        try:
            ...
            self._active = _make_icon(svg, QColor('#2997FF'))
...
def setup_tray(app):
    ...
    m = QMenu()
    m.setStyleSheet(APPLE_THEME['tray_menu_css'])
